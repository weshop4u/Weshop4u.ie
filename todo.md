...
- [x] FEATURE: Custom category sort order in store dashboard Products dropdown and customer-facing store page — priority tiers: Deli, Fizzy Drinks, Energy Drinks, Water and Flavoured Water, Chocolate Bars, Chocolate Multi Packs and Boxes, Crisps and Nuts, Biscuits and Cookies, Tobacco and Cigars and Papers, Vapes and Vape Oils, Spirits, Cans and Bottles, Flavored Alcohol, Wines, Nicotine Products — then rest alphabetically
- [x] CLEANUP: Deleted 9 unwanted SPAR categories — BreakFast Bundles, XL Chocolate, XL DRINKS, XL Halloween, XL Iced Coffees, XL Treats, Gifts for Him, Gifts for Her, Gifts for Kids — and soft-deleted 96 products in those categories
