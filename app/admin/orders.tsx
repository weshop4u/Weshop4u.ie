                                ...
                                <View key={idx2}>
                                  <View style={{ flexDirection: "row", justifyContent: "space-between", paddingVertical: 2 }}>
                                    <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
                                        ...
                                        <TouchableOpacity onPress={() => { if (Platform.OS === "web") { (window as any).open(`/api/web/admin/manage-products?store=${order.storeId}&search=${encodeURIComponent(item.productName)}`, "_blank"); } }}>
